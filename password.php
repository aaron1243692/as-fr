...
<body class="vh-100 bg-gray-200 flex flex-row justify-content-center">
    ...
    style="background-image: url('uploads/bg.jpg');">
        ...
        <form action="config/update-password.php" method="post" 
            ...
            bg-black">Password</h3>

            <div class="input-wrapper w-full">
                <input type="text" id="" name="current" class="input-field" required placeholder=" ">
                <label for="">Current Password:</label>
            </div>

            <div class="input-wrapper w-full">
                <input type="text" id="" name="new" class="input-field" required placeholder=" ">
                <label for="">New Password:</label>
            </div>

            <div class="input-wrapper w-full">
                <input type="text" id="" name="confirm" class="input-field" required placeholder=" ">
